...
(defprotocol DBQuerier
  ...
  (get-post-image-header [this post-key])
  (get-post-image-headliner [this post-key])
  (get-post-image-small [this post-key])
  (get-post-image-thumb [this post-key])
  ...
  (set-post-image-header [this post-key value])
  (set-post-image-headliner [this post-key value])
  (set-post-image-small [this post-key value])
  (set-post-image-thumb [this post-key value])
